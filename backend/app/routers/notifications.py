...
def creer_notification(
    ...
    if payload.id_axe is not None:
        # Anti-IDOR : réutilise le même contrôle de propriété que partout
        # ailleurs (_get_axe_ou_404, routers/axes.py) plutôt qu'une jointure
        # inline dupliquée. L'ancienne jointure directe vers Programme
        # excluait silencieusement toute Construction sans Saison (bug de
        # même nature que celui corrigé en Mission 5 sur _get_axe_ou_404) —
        # corrigé ici en réutilisant l'unique implémentation correcte.
