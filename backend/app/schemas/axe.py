...
class AxeOut(BaseModel):
    id_axe: int
    nom: str
    # Mission 5 : Optional — une Construction moderne rattachée à une Saison
    # peut apparaître ici (même Programme parent) sans avoir ces notions
    # Wakati (§11/§12). Toujours renseigné pour un Axe historique, jamais
    # cassé pour lui.
    phase_deverrouillage: int | None
    ordre_affichage: int
    pilier: Pilier | None
